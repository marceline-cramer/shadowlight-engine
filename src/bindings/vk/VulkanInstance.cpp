...
VulkanInstance::VulkanInstance(Window* _window, Filesystem* _fs)
{
    window = _window;
    fs = _fs;
...
void VulkanInstance::createSampler(VkSampler& sampler)
{
...
void VulkanInstance::copyBuffer(VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
...
void VulkanInstance::transitionImageLayout(VkCommandBuffer commandBuffer, VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
...
void VulkanInstance::copyBufferToImage(VkCommandBuffer commandBuffer, VkBuffer buffer, VkImage image, uint32_t width, uint32_t height)
{
